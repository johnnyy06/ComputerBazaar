...
const DashboardStats: React.FC<StatsProps> = ({ stats }) => {
  ...
  const safeRecentOrders = Array.isArray(stats.recentOrders)
    ? stats.recentOrders
    : [];
  const safeTopProducts = Array.isArray(stats.topProducts)
    ? stats.topProducts
    : [];
    ...
    <div className="dashboard-stats">
      ...
      <div className="row">
        ...
        <div className="col-md-3">
          <div className="stat-card">
            ...
            <span className="text-white-50 small">Total comenzi</span>
          </div>
        </div>
      </div>
      ...
      {stats.lowStockCount > 0 && (
        <div className="alert alert-warning mt-4">
          ...
          <strong>{stats.lowStockCount} produse</strong> au stocul scăzut (mai
          puțin de 5 bucăți).
